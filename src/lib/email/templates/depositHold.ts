    ...
    <div style="padding: 30px 20px; line-height: 1.6; color: #333;">
      ...
      <div style="background: #EFF6FF; border-left: 4px solid #3B82F6; padding: 15px; border-radius: 4px; margin: 20px 0;">
        ...
        <p style="margin: 8px 0 0 0; color: #1E40AF !important; font-size: 14px;">
          Une empreinte bancaire de <strong>${data.depositAmount.toFixed(2)}€</strong> a été effectuée sur votre carte.
        </p>
        <p style="margin: 8px 0 0 0; color: #1E40AF !important; font-size: 14px;">
      ...
      <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
        ...
        <div style="padding: 10px 0; border-bottom: 1px solid #e5e7eb;">
          <div style="display: flex; justify-content: space-between;">
            ...
            <span style="color: #3B82F6 !important; font-weight: bold;">${data.depositAmount.toFixed(2)}€</span>
          </div>
        </div>
        ...
        <div style="padding: 10px 0;">
          <div style="display: flex; justify-content: space-between;">
            ...
            <span style="color: #3B82F6 !important; font-weight: bold; font-size: 18px;">${data.totalPrice.toFixed(2)}€</span>
          </div>
        </div>
      </div>
