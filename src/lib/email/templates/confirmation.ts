...
<head>
  ...
  <style>
    @media (prefers-color-scheme: dark) {
      ...
      .info-box { background: #065f46 !important; border-color: #059669 !important; }
      .info-box p { color: #d1fae5 !important; }
    }
  </style>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; background-color: #f3f4f6;">
  <div class="email-container" style="max-width: 600px; margin: 0 auto; background: white; border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb;">
    ...
    <div class="email-header" style="background: linear-gradient(135deg, #10B981 0%, #059669 100%); color: white; padding: 40px 24px; text-align: center;">
      ...
      <p style="margin: 0; font-size: 17px; opacity: 0.95; font-weight: 500;">Merci pour votre confiance</p>
    </div>

    <!-- Contenu -->
    <div class="email-content" style="padding: 36px 24px; line-height: 1.7; color: #1f2937;">
      <p style="margin: 0 0 16px 0; font-size: 16px;">Bonjour <strong style="color: #10B981;">${
        data.name
      }</strong>,</p>

      <p style="margin: 0 0 24px 0; font-size: 16px;">Nous avons bien reçu votre réservation. Vous trouverez ci-dessous tous les détails.</p>

      ${
        data.depositAmount
          ? `
      <!-- Info Box Empreinte -->
      <div class="info-box" style="background: #f0fdf4; border-left: 4px solid #10B981; padding: 20px; border-radius: 8px; margin: 28px 0;">
        <p style="margin: 0 0 12px 0; font-weight: 700; color: #065f46; font-size: 16px;">💳 Empreinte bancaire effectuée</p>
        <p style="margin: 0; color: #065f46; font-size: 15px; line-height: 1.7;">
          Une empreinte bancaire de <strong>${(
            data.depositAmount / 100
          ).toFixed(
            2
          )}€</strong> soit <strong>50%</strong> du montant de la réservation a été effectuée sur votre carte. Cette empreinte sera automatiquement annulée le jour de votre présence lors de votre règlement sur place.
        </p>
      </div>
      `
          : ""
      ...
      <div class="details-box" style="background: #f9fafb; padding: 24px; border-radius: 12px; margin: 28px 0; border: 1px solid #e5e7eb;">
        <h3 style="margin: 0 0 20px 0; color: #10B981; font-size: 19px; font-weight: 700; letter-spacing: -0.3px;">📋 Détails de votre réservation</h3>
        ...
        <div style="padding: 16px 0 0 0;">
          <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
            <tr>
              ...
              <td class="price-value" style="text-align: right; color: #10B981; font-weight: 700; font-size: 22px; letter-spacing: -0.5px;">${data.totalPrice.toFixed(
                2
              )}€</td>
            </tr>
          </table>
      ...
      <p style="margin: 28px 0 0 0; font-size: 16px; line-height: 1.7;">Nous vous attendons avec plaisir dans nos locaux !</p>
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" style="width: 100%;">
          <tr>
            <td style="padding: 4px 0; font-size: 15px; color: #065f46;">
              <strong>Téléphone :</strong> <a href="tel:0987334519" style="color: #10B981; text-decoration: none;">09 87 33 45 19</a>
            </td>
          </tr>
          <tr>
            <td style="padding: 4px 0; font-size: 15px; color: #065f46;">
              <strong>Email :</strong> <a href="mailto:strasbourg@coworkingcafe.fr" style="color: #10B981; text-decoration: none;">strasbourg@coworkingcafe.fr</a>
            </td>
          </tr>
        </table>
      </div>
