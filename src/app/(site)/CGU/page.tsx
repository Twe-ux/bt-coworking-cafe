          ...
          <div className="col-lg-9">
            <div className="legal-content">
              ...
              >
                ...
                <ul className="text-dark mb-4">
                  <li className="mb-2">
                    Les détails de la réservation (date, heure, espace)
                  </li>
                  <li className="mb-2">Le montant total à régler</li>
                  <li className="mb-2">
              ...
              >
                ...
                <p className="text-dark" style={{ lineHeight: "1.8" }}>
                  En cas de force majeure (maladie avec certificat médical,
                  grève des transports, etc.), un remboursement ou un report
                  peut être accordé à la discrétion de la direction.
                </p>
              </section>
