        ...
        <Row className="justify-content-center">
          <Col xl={5}>
            <Card className="auth-card">
              <CardBody className="px-3 py-5">
                <div className="mx-auto mb-4 text-center auth-logo">
                  <Link href="/dashboard/dashboards/analytics" className="logo-dark">
                    <Image src={logoDark} height={32} alt="logo dark" />
                  </Link>
                  <Link href="/dashboard/dashboards/analytics" className="logo-light">
                ...
                <div className="px-4">
                  <form className="authentication-form" onSubmit={login}>
                    ...
                    <div className="mb-3">
                      <Link href="/dashboard/auth/reset-password" className="float-end text-muted text-unline-dashed ms-1">
                        Reset password
                      </Link>
                      <TextFormInput
                        control={control}
            ...
            <p className="mb-0 text-center text-white">
              New here?{' '}
              <Link href="/dashboard/auth/sign-up" className="text-reset text-unline-dashed fw-bold ms-1">
                Sign Up
              </Link>
            </p>
          </Col>
